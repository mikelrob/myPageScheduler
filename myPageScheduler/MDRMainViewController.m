...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString: //@"http://mikels-macbook-air.local/~mikelrob/ksIndex.html"];
...
//    NSLog(@"%@", webContentString);
    NSRange rangeOfscheduleAvailableString = [webContentString rangeOfString:@"Schedule is not available for the selected week"];
    if (!(rangeOfscheduleAvailableString.location == NSNotFound)) {
        NSLog(@"schedule not created yet");
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Schedule not available"
                                                        message:@"Your Schedule is not available for the selected week"
                                                       delegate:self
                                              cancelButtonTitle:nil
                                              otherButtonTitles:@"Ok", nil];
        alert.tag = kScheduleNotAvailableAlert;
        [alert show];
